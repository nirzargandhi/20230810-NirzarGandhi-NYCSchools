...
struct Utility {
    ...
    func showLoader() {
        DispatchQueue.main.async {
            ...
            hud.contentColor = .appPrimaryFont()
        }
    }
    ...
    func dynamicToastMessage(strImage : String = "ic_info", strMessage : String) {
        ...
        mainThread {
            ...
            imgvIcon.tintColor = .appBackground()
            ...
            lblMessage.textColor = .appBackground()
            ...
            vMessage.backgroundColor = .appPrimaryFont()
    ...
    //MARK: - Set Root SchoolListVC Method
    func setRootSchoolListVC() {
        let objSchoolListVC = AllStoryBoard.Main.instantiateViewController(withIdentifier: ViewControllerName.kSchoolListVC) as? SchoolListVC
        let navigationViewController = UINavigationController(rootViewController: objSchoolListVC!)
...
//MARK: - Logout User Automatically Method
func logoutUserAutomatically() {
