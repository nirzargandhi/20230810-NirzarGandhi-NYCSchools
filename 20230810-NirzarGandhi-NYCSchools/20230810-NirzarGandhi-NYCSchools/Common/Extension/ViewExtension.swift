...
extension UIView {
    ...
    func getGradient() -> CAGradientLayer {
        ...
        let colorBottom = UIColor.appButtonBg().cgColor
        ...
        layer.frame = CGRect(x: 0.0, y: 0.0, width: self.frame.width, height: self.frame.height)
...
extension UIView {
    ...
    @discardableResult
    func anchorTinder(top: NSLayoutYAxisAnchor? = nil,
                      left: NSLayoutXAxisAnchor? = nil,
                      bottom: NSLayoutYAxisAnchor? = nil,
                      right: NSLayoutXAxisAnchor? = nil,
